...
public class InstrumentationPassTest : RazorProjectEngineTestBase
{
    ...
    public void InstrumentationPass_SkipsCSharpExpression_InsideTagHelperAttribute()
    {
        ...
        builder.Push(new TagHelperIntermediateNode(tagName: null!, tagMode: 0));

        builder.Push(new TagHelperHtmlAttributeIntermediateNode(attributeName: null!, attributeStructure: 0));
    ...
    public void InstrumentationPass_InstrumentsTagHelper()
    {
        ...
        builder.Add(new TagHelperIntermediateNode(tagName: null!, tagMode: 0)
        {
