...
";
    ...
    public void RazorPageDocumentClassifierPass_SetsClass()
    {
        ...
        Assert.Equal("global::Microsoft.AspNetCore.Mvc.RazorPages.Page", baseTypeNode.BaseType.Content);
    ...
    public void RazorPageDocumentClassifierPass_SetsUpExecuteAsyncMethod()
    {
        ...
        Assert.Equal("global::System.Threading.Tasks.Task", methodNode.ReturnTypeName);
        Assert.Equal<Content>(["public", "async", "override"], methodNode.Modifiers);
    }
