...
public class CodeGenerationIntegrationTest : IntegrationTestBase
{
    ...
    private void RunRuntimeTagHelpersTest(IEnumerable<TagHelperDescriptor> descriptors, string testName)
    {
        ...
        // Act
        var codeDocument = projectEngine.Process(RazorSourceDocument.ReadFrom(projectItem), RazorSourceCodeKind.Legacy, imports, descriptors.ToList());
    ...
    private void RunDesignTimeTagHelpersTest(IEnumerable<TagHelperDescriptor> descriptors, string testName)
    {
        ...
        // Act
        var codeDocument = projectEngine.ProcessDesignTime(RazorSourceDocument.ReadFrom(projectItem), RazorSourceCodeKind.Legacy, imports, descriptors.ToList());
