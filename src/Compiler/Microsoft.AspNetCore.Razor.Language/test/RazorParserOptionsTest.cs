...
public class RazorParserOptionsTest
{
    ...
    {
        // Arrange & Act
        var builder = new RazorParserOptions.Builder(RazorLanguageVersion.Latest, RazorSourceCodeKind.Legacy);
    ...
    {
        // Arrange & Act
        var builder = new RazorParserOptions.Builder(RazorLanguageVersion.Version_2_1, RazorSourceCodeKind.Legacy);
        var options = builder.ToOptions();
    ...
    {
        // Arrange & Act
        var builder = new RazorParserOptions.Builder(RazorLanguageVersion.Version_1_0, RazorSourceCodeKind.Legacy);
        var options = builder.ToOptions();
