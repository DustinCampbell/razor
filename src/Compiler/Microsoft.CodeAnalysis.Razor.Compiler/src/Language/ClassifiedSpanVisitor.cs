    ...
    public override void VisitRazorCommentBlock(RazorCommentBlockSyntax node)
    {
        WriteBlock(node, BlockKindInternal.Comment, razorCommentSyntax =>
        {
            ...
            if (comment.IsMissing)
            {
                    ...
                    comment = (SyntaxToken)SyntaxFactory.Token(SyntaxKind.Marker, string.Empty).Node.CreateRed(razorCommentSyntax, razorCommentSyntax.StartCommentStar.EndPosition);
            }
