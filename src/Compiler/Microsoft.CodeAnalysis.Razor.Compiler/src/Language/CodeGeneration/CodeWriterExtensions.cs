...
internal static class CodeWriterExtensions
{
    ...
    public static CodeWriter WriteIntegerLiteral(this CodeWriter writer, int value)
    {
        ...
        builder.AppendIntegerLiteral(value);

        builder.WriteAllContentAndClear(writer);
    ...
    public static CodeWriter WriteStartAssignment(
        ...
        ref ContentInterpolatedStringHandler left)
    {
    ...
    public static CodeWriter WriteStartMethodInvocation(this CodeWriter writer, ref ContentInterpolatedStringHandler methodName)
    {
...
#nullable disable
    ...
    public static CodeWriter WriteMethodInvocation(
        this CodeWriter writer,
        ref ContentInterpolatedStringHandler methodName,
        params ImmutableArray<string> arguments)
