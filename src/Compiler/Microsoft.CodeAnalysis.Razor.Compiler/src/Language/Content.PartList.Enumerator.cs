...
public readonly partial struct Content
{
    public readonly ref partial struct PartList
    {
        ...
        ///  </para>
        /// </remarks>
        /// <param name="parts">The <see cref="PartList"/> to enumerate.</param>
        public ref struct Enumerator(PartList parts)
        {
            private Context _context = new(parts._content);
            private readonly bool _hasNestedContent = parts._content.HasNestedContent;
