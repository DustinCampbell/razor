    ...
    bool includeSource = false)
{
    ...
    private void WriteEscaped(Content content)
    {
        ...
        {
            // This only allocates if the part is string slice. However, the IntermediateNodeFormatter
            // is only used for debugging - not a big deal.
            ...
            {
                _builder.Append(partText, startIndex, partText.Length - startIndex);
            }
        }
    }
