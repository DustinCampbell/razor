...
internal partial class CSharpExpressionLiteralSyntax : ILegacySyntax
{
    ...
    public CSharpExpressionLiteralSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
