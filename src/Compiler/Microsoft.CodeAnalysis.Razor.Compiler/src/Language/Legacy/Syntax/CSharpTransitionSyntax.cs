...
internal partial class CSharpTransitionSyntax : ILegacySyntax
{
    ...
    public CSharpTransitionSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
        => Update(Transition, chunkGenerator, editHandler);
}
