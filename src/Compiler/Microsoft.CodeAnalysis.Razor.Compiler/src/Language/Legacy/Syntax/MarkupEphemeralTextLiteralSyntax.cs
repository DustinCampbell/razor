...
internal partial class MarkupEphemeralTextLiteralSyntax : ILegacySyntax
{
    ...
    public MarkupEphemeralTextLiteralSyntax Update(ISpanChunkGenerator? chunkGenerator, SpanEditHandler? editHandler)
