...
internal static class TagHelperBlockRewriter
{
        ...
        RazorSourceDocument source)
    {
        ...
        for (var i = 0; i < startTag.Attributes.Count; i++)
        {
                 ...
                 string.IsNullOrWhiteSpace(GetAttributeValueContent(result.RewrittenAttribute))))
            {
                ...
                var propertyTypeName = GetPropertyType(result.AttributeName, bindingResult.TagHelpers);
    ...
    private static string GetPropertyType(string name, TagHelperCollection descriptors)
    {
