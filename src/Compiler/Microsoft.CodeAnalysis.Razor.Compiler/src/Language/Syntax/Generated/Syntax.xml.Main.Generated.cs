...
internal partial class SyntaxRewriter : SyntaxVisitor<SyntaxNode>
{
    public override SyntaxNode VisitRazorDocument(RazorDocumentSyntax node)
        => node.Update((RazorBlockSyntax)Visit(node.Document), (OldSyntaxToken)VisitToken(node.EndOfFile));

    public override SyntaxNode VisitRazorCommentBlock(RazorCommentBlockSyntax node)
        => node.Update((OldSyntaxToken)VisitToken(node.StartCommentTransition), (OldSyntaxToken)VisitToken(node.StartCommentStar), (OldSyntaxToken)VisitToken(node.Comment), (OldSyntaxToken)VisitToken(node.EndCommentStar), (OldSyntaxToken)VisitToken(node.EndCommentTransition));
    ...
    public override SyntaxNode VisitMarkupAttributeBlock(MarkupAttributeBlockSyntax node)
        => node.Update((MarkupTextLiteralSyntax)Visit(node.NamePrefix), (MarkupTextLiteralSyntax)Visit(node.Name), (MarkupTextLiteralSyntax)Visit(node.NameSuffix), (OldSyntaxToken)VisitToken(node.EqualsToken), (MarkupTextLiteralSyntax)Visit(node.ValuePrefix), (RazorBlockSyntax)Visit(node.Value), (MarkupTextLiteralSyntax)Visit(node.ValueSuffix));
    ...
    public override SyntaxNode VisitMarkupStartTag(MarkupStartTagSyntax node)
        => node.Update((OldSyntaxToken)VisitToken(node.OpenAngle), (OldSyntaxToken)VisitToken(node.Bang), (OldSyntaxToken)VisitToken(node.Name), VisitList(node.Attributes), (OldSyntaxToken)VisitToken(node.ForwardSlash), (OldSyntaxToken)VisitToken(node.CloseAngle), node.ChunkGenerator);

    public override SyntaxNode VisitMarkupEndTag(MarkupEndTagSyntax node)
        => node.Update((OldSyntaxToken)VisitToken(node.OpenAngle), (OldSyntaxToken)VisitToken(node.ForwardSlash), (OldSyntaxToken)VisitToken(node.Bang), (OldSyntaxToken)VisitToken(node.Name), (MarkupMiscAttributeContentSyntax)Visit(node.MiscAttributeContent), (OldSyntaxToken)VisitToken(node.CloseAngle), node.ChunkGenerator);
    ...
    public override SyntaxNode VisitMarkupTagHelperAttribute(MarkupTagHelperAttributeSyntax node)
        => node.Update((MarkupTextLiteralSyntax)Visit(node.NamePrefix), (MarkupTextLiteralSyntax)Visit(node.Name), (MarkupTextLiteralSyntax)Visit(node.NameSuffix), (OldSyntaxToken)VisitToken(node.EqualsToken), (MarkupTextLiteralSyntax)Visit(node.ValuePrefix), (MarkupTagHelperAttributeValueSyntax)Visit(node.Value), (MarkupTextLiteralSyntax)Visit(node.ValueSuffix));
    ...
    public override SyntaxNode VisitCSharpTransition(CSharpTransitionSyntax node)
        => node.Update((OldSyntaxToken)VisitToken(node.Transition), node.ChunkGenerator);
