...
internal static class SyntaxBuilderExtensions
{
    ...
    public static GreenNode? ToGreenListNode(ref readonly this PooledArrayBuilder<SyntaxToken> builder)
    {
        switch (builder.Count)
        {
            ...
            case 2:
                return InternalSyntax.SyntaxList.List(builder[0].RequiredNode, builder[1].RequiredNode);
            case 3:
                return InternalSyntax.SyntaxList.List(builder[0].RequiredNode, builder[1].RequiredNode, builder[2].RequiredNode);
