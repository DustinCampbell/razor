...
internal sealed partial class TagHelperBinder
{
    ...
    public TagHelperBinder(string? tagNamePrefix, TagHelperCollection tagHelpers)
    {
        ...
        ProcessDescriptors(tagHelpers, tagNamePrefix, out _tagNameToDescriptorsMap, out _catchAllDescriptors);
    }
        ...
        out TagHelperSet catchAllDescriptors)
    {
        ...
        using var _ = SpecializedPools.GetPooledStringDictionary<int>(ignoreCase: true, out var tagNameToBuilderIndexMap);
