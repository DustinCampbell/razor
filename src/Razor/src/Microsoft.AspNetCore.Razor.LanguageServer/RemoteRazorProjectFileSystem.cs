...
internal sealed class RemoteRazorProjectFileSystem : RazorProjectFileSystem
{
    ...
    public override RazorProjectItem GetItem(string path, string? fileKind)
    {
        ...
        if (FilePathRootedBy(physicalPath, _root))
        {
            ...
            return new RemoteProjectItem(filePath, physicalPath, RazorFileKinds.FromString(fileKind));
        }
        else
        {
            ...
            return new RemoteProjectItem(physicalPath, physicalPath, RazorFileKinds.FromString(fileKind));
        }
    }
