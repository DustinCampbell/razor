...
public class RazorCompletionEndpointTest(ITestOutputHelper testOutput) : LanguageServerTestBase(testOutput)
{
    ...
    public async Task Handle_NoDocumentContext_NoCompletionItems()
    {
        ...
        var completionEndpoint = new RazorCompletionEndpoint(completionListProvider: null, completionTriggerAndCommitCharacters: null, NoOpTelemetryReporter.Instance, optionsMonitor);
