    ...
    : FormattingTestBase(context, fixture.Service, testOutput), IClassFixture<FormattingTestContext>
{
    ...
    public async Task FormatNestedCascadingValue()
    {
        await RunFormattingTestAsync(
            ...
            expected: """
                    ...
                    """,
            sourceCodeKind: RazorSourceCodeKind.Component);
    }
    ...
    public async Task FormatNestedCascadingValue2()
    {
        await RunFormattingTestAsync(
            ...
            expected: """
                    ...
                    """,
            sourceCodeKind: RazorSourceCodeKind.Component); // tracked by https://github.com/dotnet/razor/issues/10836
    }
    ...
    public async Task Formats_NoEditsForNoChanges()
    {
        ...
        await RunFormattingTestAsync(input, input, sourceCodeKind: RazorSourceCodeKind.Component);
    }
