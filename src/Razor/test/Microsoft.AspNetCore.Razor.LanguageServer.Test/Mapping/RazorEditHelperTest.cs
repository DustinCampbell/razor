...
public class RazorEditHelperTest : LanguageServerTestBase
{
    ...
    private sealed class FailingTelemetryReporter : ITelemetryReporter
    {
        public static readonly ITelemetryReporter Instance = new FailingTelemetryReporter();

        private FailingTelemetryReporter()
        {
        }
