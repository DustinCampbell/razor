...
#nullable enable
    ...
    public async Task IProjectInfoListener_UpdatedAsync_AddsNewDocuments()
    {
        // Arrange
        var hostProject = new HostProject(new ProjectKey("C:/path/to/obj"), "C:/path/to/project.csproj", RazorConfiguration.Default, "TestRootNamespace");
        var oldDocument = new HostDocument("C:/path/to/file.cshtml", "file.cshtml", FileKinds.Legacy);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_KnownDocuments()
    {
        ...
        var newDocument = new HostDocument("path/to/file.cshtml", "file.cshtml", FileKinds.Legacy);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_UpdatesLegacyDocumentsAsComponents()
    {
        ...
        var newDocument = legacyDocument with { FileKind = FileKinds.Component };
