...
internal static class TagHelperTestData
{
    ...
    public static TagHelperCollection Project1TagHelpers { get; }
    ...
    public static TagHelperCollection Project2TagHelpers { get; }
    public static ImmutableArray<Checksum> Project2TagHelperChecksums { get; }
    public static TagHelperCollection Project1AndProject2TagHelpers { get; }
    ...
    static TagHelperTestData()
    {
        ...
        Project1TagHelpers = [TagHelper1_Project1, TagHelper2_Project1];
        ...
        Project2TagHelpers = [TagHelper1_Project2, TagHelper2_Project2];
        Project2TagHelperChecksums = Project2TagHelpers.SelectAsArray(t => t.Checksum);

        Project1AndProject2TagHelpers = [TagHelper1_Project1, TagHelper2_Project1, TagHelper1_Project2, TagHelper2_Project2];
