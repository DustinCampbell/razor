...
#nullable enable
    ...
    protected override async Task InitializeAsync()
    {
        ...
        var hostDocument1 = new HostDocument(@"C:\document1.razor", "document1.razor", RazorSourceCodeKind.Component);
        var hostDocument2 = new HostDocument(@"C:\document2.razor", "document2.razor", RazorSourceCodeKind.Component);
