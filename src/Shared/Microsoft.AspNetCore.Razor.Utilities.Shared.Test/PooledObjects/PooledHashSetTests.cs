...
public class PooledHashSetTests
{
    ...
    [Fact]
    public void UnionWith_Enumerable_Null_NoChange()
    {
        using var set = new PooledHashSet<int>();
        set.Add(42);
    ...
    [Fact]
    public void UnionWith_Enumerable_Empty_NoChange()
    {
        using var set = new PooledHashSet<int>();
        set.Add(42);
    ...
    [Fact]
    public void UnionWith_Enumerable_SingleItem_AddsItem()
    {
        using var set = new PooledHashSet<int>();

        IEnumerable<int> other = [42];
        set.UnionWith(other);
    ...
    [Fact]
    public void UnionWith_Enumerable_MultipleItems_AddsAllItems()
    {
        using var set = new PooledHashSet<int>();

        IEnumerable<int> other = [42, 24, 99];
        set.UnionWith(other);
    ...
    [Fact]
    public void UnionWith_Enumerable_WithExistingItems_UnionCorrectly()
    {
        using var set = new PooledHashSet<int>();
        set.Add(42);

        IEnumerable<int> other = [24, 99, 42];
        set.UnionWith(other);
